...
type OptionalIconMap = Partial<Record<"Add01Icon" | "DashboardSquare01Icon" | "SentIcon" | "Settings02Icon", IconSvgElement>>;
const hugeiconsModule = require("@hugeicons/core-free-icons") as OptionalIconMap;
...
const Add01Icon = hugeiconsModule.Add01Icon ?? FALLBACK_ADD01_ICON;
const DashboardSquare01Icon = hugeiconsModule.DashboardSquare01Icon ?? FALLBACK_DASHBOARD_ICON;
const SentIcon = hugeiconsModule.SentIcon ?? FALLBACK_SENT_ICON;
const Settings02Icon = hugeiconsModule.Settings02Icon ?? FALLBACK_SETTINGS_ICON;
